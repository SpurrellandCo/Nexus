...
When the user wants to **implement** CRO changes, produce this brief before spawning:

**When:** User says "make these changes", "implement this", "update the page"
**Agent:** `coder`

Brief to produce:
```
Task: Implement CRO changes on [page]
Agent: coder
Files: [specific page or component file]
Changes:
  - [specific change 1 — e.g. "Move CTA above the fold in HeroSection.tsx"]
  - [specific change 2 — e.g. "Replace hero headline with: [text]"]
  - [specific change 3]
