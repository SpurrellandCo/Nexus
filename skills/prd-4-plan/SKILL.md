...
Scope Check: flag any task with no matching PRD requirement. Resolve as drift update, defer, or sub-PRD trigger. Must produce ≥2 independent phases. Next step: `/prd-5-architect`
