...
When the user wants to **build or update** design system components, produce this brief before spawning:

**When:** User says "build this component", "implement the tokens", "create the component library"
**Agent:** `coder`

Brief to produce:
```
Task: Build/update design system [component or token set]
Agent: coder
Files: [component file path, design-tokens.css, tailwind.config.ts]
Changes:
  - [specific change 1 — e.g. "Create Button component with variants: primary, secondary, ghost"]
  - [specific change 2 — e.g. "Add spacing tokens to tailwind.config.ts per token table above"]
  - [specific change 3]
