...
Then write the JSON to disk at this exact absolute path (no relative paths: your tool may resolve them against an unknown working directory and the file would be silently lost):
CHUNK_PATH
```
